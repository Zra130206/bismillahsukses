...
class BarangKeluarController extends Controller
{
    ...
    // Periksa ketersediaan stok sebelum update
    $stokTersedia = $barang->stok + $barangkeluar->qty_keluar; // Tambahkan kembali stok barang yang sebelumnya keluar
    if ($request->qty_keluar > $stokTersedia) {
        return redirect()->back()->withErrors(['qty_keluar' => 'Jumlah keluar melebihi stok yang tersedia'])->withInput();
    }
    ...
    $barang->stok = $stokTersedia - $request->qty_keluar;
    $barang->save();
